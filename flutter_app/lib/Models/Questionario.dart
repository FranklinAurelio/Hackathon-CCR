...
class Questionario {
  ...
  String descricao;
    ...
    reponder(String reposta){
      respostas.add(reposta);
    }

    getResultado(){
      if (titulo == "Questionário sobre falta de ar") {
        if (respostas.asMap()[1] =="sim" && (respostas.asMap()[2] == "asma"|| respostas.asMap()[2]=="enfisema")) {
          return "Se você tiver uma bombinha, utilize-a,e espere alguns minutos, caso a falta de ar persista, procure ajuda médica";
        } else if (respostas.asMap()[3] == "sim" || respostas.asMap()[4] == "sim" || respostas.asMap()[5] == "sim" || respostas.asMap()[6] == "sim" || respostas.asMap()[7] == "sim"){
        ...
        } else if (respostas.asMap()[0] == "sim" || respostas.asMap()[2] == "sim" || respostas.asMap()[4] == "sim" || respostas.asMap()[5] == "sim") {
        ...
        if (titulo == "Questioário febre") {
          if (respostas.asMap()[0] == "sim" || respostas.asMap()[1] == "sim" || respostas.asMap()[2] == "sim" || respostas.asMap()[3] == "sim" && respostas.asMap()[4] == "sim") {
            return "Você apresenta sintomas de dengue, procure um posto médico ou a telemedicina";
          } else if (respostas.asMap()[0] == "sim" || respostas.asMap()[1] == "sim" || respostas.asMap()[2] == "sim" || respostas.asMap()[3] == "sim") {
        ...
        if (respostas.asMap()[1] == "sim" || respostas.asMap()[2] == "sim" || respostas.asMap()[3] == "sim" ) {
        ...
        if ( respostas.asMap()[0] == "sim"|| respostas.asMap()[1] == "sim"|| respostas.asMap()[2] == "sim"|| respostas.asMap()[3] == "sim"|| respostas.asMap()[4] == "sim"
            || respostas.asMap()[5] == "sim" || respostas.asMap()[6] == "sim") {
        ...
        if ( respostas.asMap()[0] == "sim" || respostas.asMap()[1] == "sim" || respostas.asMap()[3] == "sim"
            || respostas.asMap()[4] == "não" || respostas.asMap()[5] == "sim" || respostas.asMap()[6] == "sim") {
        ...
        if (respostas.asMap()[0] == "sim" || respostas.asMap()[1] == "sim" || respostas.asMap()[2] == "sim" || respostas.asMap()[3] == "sim" || respostas.asMap()[4] == "não") {
        ...
        if ( respostas.asMap()[3] == "sim" || respostas.asMap()[4] == "sim" || respostas.asMap()[5] == "sim" || respostas.asMap()[6] == "sim" || respostas.asMap()[7] == "sim") {
